...
The people who produce the best work tend to be the people who produce the most work.\marginnote{Witness Euler, Gauss, Picasso, Dali,
  Stephen King, Issac Asimov, Bach, Rush.}
...
competitive.\marginnote{I'm happy to say their seem to be a rising number of cooperative games, such as Pandemic. Fantasy role playing games have
...
than a lead role in a cage.\marginnote{``Wish You Were Here''}
...
evidence.''\marginnote{(ECREE), the Sagan Standard.} Often the modern quack will say, ``I will
...
publish differently.  The difference in meaning in the word publish
...
community, as we learned at a recent hackathon on behalf of Project
Drawdown.  Publication: Free Software Publication means putting
...
possibly linked to by others.  Academic Publication means putting a
...
process of implementing the project.  This essay is an attempt to
...
Scientific papers can be intimidating and confusing.\marginnote{
  The first math apaper I tried to read when I was in High School
...
this impossible.\marginnote{ I sometimes can't tell what a math paper is even about.} Sometimes you can skim a paper to understand its ``shape'', which
...
idea and not immediately explainging to them what I thought was wrong with it.\marginnote{I got better.}
