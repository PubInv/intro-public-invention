...
\chapter{Makers into Public Inventors}
...
\item Resisting the siren songs of praise, the ``in club''\marginnote{Find quote by C.S. Lewis on the ``In club''}
...
as FIRST robotics teams or Combat robotics.
...
The idea of the Invention Coach as a technical manager.
...
\chapter{Public Invention Teaches, but is not an educational organization}
...
\item Learning is a precessional outcome of Public Invention activity
  \item Universitied are a pole but are based on exclusivity
\end{itemize}
